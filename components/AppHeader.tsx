 ...
 * 타이틀-이메일-설정-로그아웃을 한 그룹으로 묶어서, 좁은 화면에서 줄바꿈되더라도
 * 서로 붙어서 보이게 한다(justify-between으로 양 끝에 벌려두면 모바일에서 따로
 * 떨어져 보인다).
 */
export default function AppHeader() {
  ...
  return (
    <header className="flex flex-wrap items-center gap-x-6 gap-y-3 border-b border-black/[.08] px-4 py-3 sm:px-6 sm:py-4 dark:border-white/[.145]">
